Built a real-time Virtual Paint App using Python, OpenCV, and MediaPipe to allow users to draw in the air using hand gestures, without touching the screen or using a mouse. 
